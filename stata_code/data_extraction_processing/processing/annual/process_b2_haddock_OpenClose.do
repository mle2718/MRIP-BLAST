...
use  "$my_outputdir/haddock_landings_OpenClose_$working_year.dta", clear
gen ab1=landings
keep year open ab1
...
use "$my_outputdir/haddock_b2_OpenClose_$working_year.dta", clear
...
/* save */
save  "$my_outputdir/haddock_b2_counts_OpenClose_$working_year.dta", replace




use  "$my_outputdir/haddock_ab1_OpenClose_$working_year.dta", clear
...
merge 1:1 year open l_in_bin using  "$my_outputdir/haddock_b2_counts_OpenClose_$working_year.dta"
...
save  "$my_outputdir/haddock_size_class_OpenClose_$working_year.dta", replace
