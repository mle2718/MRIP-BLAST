/* This is a file that produces data on a, b1, b2, and other top-level catch statistics by month and mode
...
gen my_dom_id_string=year2+area_s+"_"+mode+ "_"+month+"_"+common_dom
...
keep my_dom_id year area_s month mode common_dom
...
keep if strmatch(area_s,"M")
sort year area_s month common_dom

	save "$my_outputdir/${my_common}_catch_mode_$working_year.dta", replace
