...
gen my_dom_id_string=area_s+month+common_dom
...
replace l_in_bin=0 if strmatch(common, "$my_common")==0
...
local myv l_in_bin
	...
	renvars GOM*, postdrop(3)
	renvars GOM*, postsub(a )
	...
	global cod_wave_lengths "$cod_wave_lengths "$my_outputdir/$my_common`myv'_a1b1_$working_year.dta" "
