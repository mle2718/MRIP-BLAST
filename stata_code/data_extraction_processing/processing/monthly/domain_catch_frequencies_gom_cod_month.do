/* This is a file that produces a dataset that contains # of fish encountered per trip aggregated at the monthly level.
...
local myv tot_cat
	...
	save "${my_outputdir}/$my_common`myv'_$working_year.dta", replace

global cod_wave_files "$cod_wave_files "${my_outputdir}/$my_common`myv'_$working_year.dta" "
